...
const CARD_DESTROY_SCALE: Vector2 = Vector2(0.1, 0.1)
...
const COLLISION_LAYER_CARD: int = 1  
const COLLISION_MASK_CARD: int = 1          # Layer 1 (Bit 0)
const COLLISION_LAYER_SLOT: int = 2
const COLLISION_MASK_CARD_SLOT: int = 2          
const COLLISION_LAYER_DECK: int = 4   
const COLLISION_MASK_DECK: int = 4        # Layer 3 (Bit 2)
const COLLISION_LAYER_OPPONENT_CARD: int = 8  # Layer 4 (Bit 3)
const COLLISION_MASK_OPPONENT_CARD: int = 8
const COLLISION_LAYER_OPPONENT_GRAVEYARD: int = 32
const COLLISION_LAYER_GRAVEYARD: int = 16
const COLLISION_MASK_PLAYER_GRAVEYARD: int = 16  # Corresponde à Camada 5
const COLLISION_MASK_OPPONENT_GRAVEYARD: int = 32

const MASK_INPUT_CLICK: int = COLLISION_LAYER_CARD | COLLISION_LAYER_SLOT | COLLISION_LAYER_DECK | COLLISION_LAYER_OPPONENT_CARD | COLLISION_MASK_PLAYER_GRAVEYARD | COLLISION_MASK_OPPONENT_GRAVEYARD

const STARTING_HAND_SIZE: int = 7 # Ajuste se necessário (vi 5 e 7 nos scripts)
const INITIAL_PLAYER_HEALTH: int = 20
const OPPONENT_STARTING_HAND_SIZE: int = 7 # Definido no battle_manager
